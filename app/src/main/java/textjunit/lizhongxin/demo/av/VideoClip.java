...
public class VideoClip {
    ...
    public boolean clipVideo(final Context context, String url, long clipPoint, long clipDuration) {
        ...
        try {
            ...
            //创建合成器
            File file = new File(url.substring(0, url.lastIndexOf(".")) + "_output.mp4");
