...
import textjunit.lizhongxin.demo.utils.ScreenUtils;

public class SeckillCountDownLikePoision extends View implements Runnable {
  ...
  public SeckillCountDownLikePoision(Context context) {
    super(context);
    init(context, null);
  }

  public SeckillCountDownLikePoision(Context context, AttributeSet attrs) {
    super(context, attrs);
    init(context, attrs);
  }

  public SeckillCountDownLikePoision(Context context, AttributeSet attrs, int defStyleAttr) {
  ...
  private void init(Context context, AttributeSet attrs) {
    ...
    bgSize = ScreenUtils.dp2px(context, 27);
    margin = ScreenUtils.dp2px(context, 12);
    numMargin = ScreenUtils.dp2px(context, 4);
    colonDrawable = ContextCompat.getDrawable(context, R.drawable.ic_time_colon);
    textColor = ContextCompat.getColor(context, R.color.white);
    textSize = ScreenUtils.dp2px(context, 16);
  ...
  private void initAttrs(Context context, AttributeSet attrs) {
    ...
    TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SeckillCountDownLikePoision);
    bgSize = a.getDimensionPixelSize(R.styleable.SeckillCountDownLikePoision_seckill_time_bg_size,
        bgSize);
    bgColor = a.getColor(R.styleable.SeckillCountDownLikePoision_seckill_time_bg, bgColor);
    Drawable colonDrawable = a
        .getDrawable(R.styleable.SeckillCountDownLikePoision_seckill_colon_drawable);
    textColor = a
        .getColor(R.styleable.SeckillCountDownLikePoision_seckill_time_text_color, textColor);
    textSize = a
        .getDimensionPixelSize(R.styleable.SeckillCountDownLikePoision_seckill_time_text_size,
            textSize);
    margin = a
        .getDimensionPixelSize(R.styleable.SeckillCountDownLikePoision_seckill_time_margin, margin);
    a.recycle();
