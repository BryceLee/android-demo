...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Retrofit retrofit = new Retrofit.Builder().client(builder.build()).addConverterFactory(GsonConverterFactory.create()) // 使用 Gson 解析
...
// /combine?service=resource.app.getDetail,op.app.article.get,op.theme.get,op.activiy.simpleActiviy.getByAppId,op.ad.getAdsByAppId"
    public interface ApiService {
        // 會返回一個 call 類別
        @POST("/api/combine?service=resource.app.getDetail,op.app.article.get,op.theme.get,op.activiy.simpleActiviy.getByAppId,op.ad" +
                ".getAdsByAppId")
