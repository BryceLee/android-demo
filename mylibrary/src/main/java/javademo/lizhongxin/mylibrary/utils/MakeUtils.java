...
public class MakeUtils {
    ...
    private static final String XML_DIMEN_TEMPLETE = "<dimen name=\"bq_%1$spx_%2$d\">%3$.2fdp</dimen>\r\n";

   
    private static final String XML_BASE_DPI = "<dimen name=\"base_dpi\">%ddp</dimen>\r\n";
    private  static final int MAX_SIZE = 1334;
...
//            fos.close();
            ...
            String s = makeAllDimens(type, designWidth);
